...
% 设置章、节、小节、小小节的间距
%\titleformat{\chapter}[hang]{\normalfont\xiaosan\rmafamily}{\xiaosan\thechapter}{10pt}{\xiaosan}
\titleformat{\section}{\CJKfamily{黑体}\normalfont\fontsize{14}{16}\selectfont}{\thesection}{1em}{\CJKfamily{黑体}\normalfont\fontsize{14}{16}\selectfont}
\titlespacing{\chapter}{0pt}{-3ex  plus .1ex minus .2ex}{3.3ex}
\titleformat{\section}[hang]{\sihao\rmafamily}{\sihao\thesection}{0.5em}{}{}
\titlespacing{\section}{0pt}{0.5em}{0.5em}
\titleformat{\subsection}[hang]{\xiaosi\rmafamily}{\xiaosi\thesubsection}{0.5em}{}{}
\titlespacing{\subsection}{0pt}{0.5em}{0.3em}
\titleformat{\subsubsection}[hang]{\rmafamily}{\thesubsubsection}{0.5em}{}{}
...
\setlength{\abovecaptionskip}{0pt}%李浩林添加设置图的标题与图之间的距离
%\setlength{\belowcaptionskip}{10pt}%李浩林添加设置图的标题与图之间的距离
...
%\newcommand{\duanhengxian}{\uline{\hspace{0.5em}}} %李浩林添加设置短横线
\newcommand{\duanhengxian}{\underline{\hspace{0.5em}}} %李浩林添加设置短横线
